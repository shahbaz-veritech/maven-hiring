  ...
  <section id="services" class="py-12 max-w-7xl mx-auto px-4 bg-white">
    <div class="flex flex-col">
      ...
      <p class="text-lg text-gray-600 w-[100%] md:w-[50%] mx-auto">
        ...
        or a curated list of pre-vetted candidates, we provide the talent you
        need to drive your company's rapid growth and success. Partner with us
        to build a world-class team that scales with your ambitions.
      </p>
    </div>
  </section>
</template>
